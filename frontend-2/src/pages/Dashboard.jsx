...
const styles = {
  page: { minHeight: '100vh', background: '#f0fff4' },
  ...
  appTag: { fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1, opacity: 0.8 },
  ...
  section: {
    ...
    padding: 24,
    marginBottom: 20,
    boxShadow: '0 2px 8px rgba(13,115,71,0.06)',
  },
